...
const projects = [
  {
    id: 1,
    title: "Engraved Lighter",
    description: "Stylish and personalized lighter with your text.",
  ...
  },
  {
    id: 2,
    title: "Engraved Pen",
    description: "Elegant pen customized with your text, and a beautiful packaging.",
  ...
  },
  {
    ...
    description: "Premium keychain engraved with your text.",
    imageUrl: "/placeholder.svg?height=600&width=800",
    category: "Keychain",
  }
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            A showcase of our minimalist designs and customized products.
          </p>
        </motion.div>
